        ...
        <div class="w-8/12 bg-white p-6 rounded-lg">
            <form action="{{route('register') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Password Confirmation" class="bg-gray-100 border-2 w-full p-4 rounded-lg">
                </div>
